...
int main( int argc, char* argv[] )
{
  ...
  const uint32_t answer_in = g.num_in_degree_k( atoi( argv[2] ) );
  const uint32_t answer_out = g.num_out_degree_k( atoi( argv[2] ) );
  cout << "[ans] number of nodes of degree " << atoi( argv[2] ) << " is: " << answer << endl;
  cout << "[ans] number of nodes of in degree " << atoi( argv[2] ) << " is: " << answer_in << endl;
  cout << "[ans] number of nodes of out degree " << atoi( argv[2] ) << " is: " << answer_out << endl;
