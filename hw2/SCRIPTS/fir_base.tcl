...
analyze -f vhdl ../SRC/fir_base/fir_base.vhd
analyze -f vhdl ../SRC/fir_base/fir_base_wrapper.vhd

# elaborate the design 
elaborate fir_base_wrapper

# set delay constraints
create_clock "Clk" -name "global_clk" -period 2
